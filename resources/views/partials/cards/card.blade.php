<div class="shadow-lg w-72  my-2 border rounded-xl">
    ...
    <div class="p-3">
        ...
        <div class="flex items-center ">
            ...
            <div class="h-4">
                <div class="text-base whitespace-nowrap overflow-hidden text-ellipsis">Cocody palmeraie rue ministre
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center py-1">
            ...
            <div class="h-4">
                <div class="text-base">Jhon Doe </div>
            </div>
        </div>
        <div class="flex items-center py-1">
            <span class="relative flex h-4 w-4 mr-3">
            ...
            <div class="h-4">
                <div class="text-sm font-bold">+225 0565381695</div>
            </div>
        </div>
